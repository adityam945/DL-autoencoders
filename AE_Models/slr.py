...
class VAE_stl(nn.Module):
    def __init__(self):
        ...
        # load data
        self.train_loader, self.test_loader = load_data_stl()
    ...
    def sampling(self):
        ...
        z = torch.randn(64, self.n_latent_features)
    ...
    def test(self, epoch):
        ...
        save_image_for_epoch(self.sampling(), self.model_name,epoch)
